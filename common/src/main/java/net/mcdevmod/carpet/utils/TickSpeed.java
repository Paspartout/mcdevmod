package net.mcdevmod.carpet.utils;
...
public class TickSpeed
{
    ...
    public static BaseText tickrate_advance(MinecraftServer server, PlayerEntity player, int advance, String callback, ServerCommandSource source)
    {
        if (0 == advance)
        {
            tick_warp_callback = null;
            tick_warp_sender = null;
            finish_time_warp(server);
    ...
    public static void finish_time_warp(MinecraftServer server)
    {
